...
_lr_productions = [
  ...
  ('calc_grammar -> expr SEMI','calc_grammar',2,'p_calc_grammar','Parser.py',183),
  ('expr -> operation_expression','expr',1,'p_expr','Parser.py',213),
  ('operation_expression -> expr PLUS expr','operation_expression',3,'p_operation_expression','Parser.py',220),
  ('operation_expression -> expr MINUS expr','operation_expression',3,'p_operation_expression','Parser.py',221),
  ('operation_expression -> expr MULTI expr','operation_expression',3,'p_operation_expression','Parser.py',222),
  ('operation_expression -> expr DIVIDE expr','operation_expression',3,'p_operation_expression','Parser.py',223),
  ('operation_expression -> expr EQUALS expr','operation_expression',3,'p_operation_expression','Parser.py',224),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_group','Parser.py',233),
  ('expr -> term','expr',1,'p_value','Parser.py',242),
  ('term -> MINUS term','term',2,'p_uminus','Parser.py',249),
  ('term -> STRING','term',1,'p_term','Parser.py',256),
  ('term -> NUMBER','term',1,'p_term','Parser.py',257),
]
