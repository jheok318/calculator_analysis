...
_lr_productions = [
  ...
  ('calc_grammar -> expr SEMI','calc_grammar',2,'p_calc_grammar','Parser.py',109),
  ('expr -> operation_expression','expr',1,'p_expr','Parser.py',118),
  ('operation_expression -> expr PLUS expr','operation_expression',3,'p_operation_expression','Parser.py',126),
  ('operation_expression -> expr MINUS expr','operation_expression',3,'p_operation_expression','Parser.py',127),
  ('operation_expression -> expr MULTI expr','operation_expression',3,'p_operation_expression','Parser.py',128),
  ('operation_expression -> expr DIVIDE expr','operation_expression',3,'p_operation_expression','Parser.py',129),
  ('operation_expression -> expr EQUALS expr','operation_expression',3,'p_operation_expression','Parser.py',130),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_group','Parser.py',140),
  ('expr -> term','expr',1,'p_value','Parser.py',150),
  ('term -> MINUS term','term',2,'p_uminus','Parser.py',158),
  ('term -> STRING','term',1,'p_term','Parser.py',166),
  ('term -> NUMBER','term',1,'p_term','Parser.py',167),
]
